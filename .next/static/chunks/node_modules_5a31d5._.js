...
function n(t) {
    const e = window.atob(t), n = e.length, s = new Uint8Array(n);
...
class a {
    static async create(t) {
        ...
        try {
            ...
            const r = e.createMediaStreamSource(n), l = new AudioWorkletNode(e, "raw-audio-processor");
            return r.connect(i), i.connect(l), new a(e, i, l, n);
        } catch (t) {
            var s, i;
...
class l {
    static async create(t) {
        ...
        try {
            ...
            const n = e.createAnalyser(), s = e.createGain();
            ...
            return o.connect(s), new l(e, n, s, o);
        } catch (t) {
            var n;
...
class u {
    static async create(t) {
        ...
        try {
            var n;
            const s = null != (n = t.origin) ? n : "wss://api.elevenlabs.io", o = t.signedUrl ? t.signedUrl : s + "/v1/convai/conversation?agent_id=" + t.agentId, a = [
                "convai"
            ];
            t.authorization && a.push(`bearer.${t.authorization}`), e = new WebSocket(o, a);
            const i = await new Promise((n, s)=>{
                e.addEventListener("open", ()=>{
                    ...
                    }), t.customLlmExtraBody && (s.custom_llm_extra_body = t.customLlmExtraBody), null == (n = e) || n.send(JSON.stringify(s));
                }, {
                    once: !0
                }), e.addEventListener("error", s), e.addEventListener("close", s), e.addEventListener("message", (t)=>{
                    const e = JSON.parse(t.data);
                    c(e) && ("conversation_initiation_metadata" === e.type ? n(e.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
                }, {
                    once: !0
                });
            }), r = i.conversation_id, l = parseInt(i.agent_output_audio_format.replace("pcm_", ""));
            return new u(e, r, l);
        } catch (t) {
            var s;
            throw null == (s = e) || s.close(), t;
        }
    }
    constructor(t, e, n){
        this.socket = void 0, this.conversationId = void 0, this.sampleRate = void 0, this.socket = t, this.conversationId = e, this.sampleRate = n;
    }
    close() {
        this.socket.close();
    }
...
class p {
    static async startSession(e) {
        ...
        try {
            return s = await a.create(16e3), o = await u.create(e), i = await l.create(o.sampleRate), new p(n, o, s, i);
        } catch (t) {
            var r, c, f;
            throw n.onStatusChange({
                status: "disconnected"
            }), null == (r = o) || r.close(), await (null == (c = s) ? void 0 : c.close()), await (null == (f = i) ? void 0 : f.close()), t;
        }
    }
    constructor(t, s, o, a){
        var i = this;
        this.options = void 0, this.connection = void 0, this.input = void 0, this.output = void 0, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.volume = 1, this.endSession = async function() {
        ...
        }, this.onEvent = async function(t) {
            try {
                const n = JSON.parse(t.data);
                if (!c(n)) return;
                switch(n.type){
                    case "interruption":
                        n.interruption_event && (i.lastInterruptTimestamp = n.interruption_event.event_id), i.fadeOutAudio();
                        break;
                    case "agent_response":
                        i.options.onMessage({
                            source: "ai",
                            message: n.agent_response_event.agent_response
                        });
                        break;
                    case "user_transcript":
                        i.options.onMessage({
                            source: "user",
                            message: n.user_transcription_event.user_transcript
                        });
                        break;
                    case "internal_tentative_agent_response":
                        i.options.onDebug({
                            type: "tentative_agent_response",
                            response: n.tentative_agent_response_internal_event.tentative_agent_response
                        });
                        break;
                    case "client_tool_call":
                        if (i.options.clientTools.hasOwnProperty(n.client_tool_call.tool_name)) {
                            try {
                                var e;
                                const t = null != (e = await i.options.clientTools[n.client_tool_call.tool_name](n.client_tool_call.parameters)) ? e : "Client tool execution successful.";
                                i.connection.sendMessage({
                                    type: "client_tool_result",
                                    tool_call_id: n.client_tool_call.tool_call_id,
                                    result: t,
                                    is_error: !1
                                });
                            } catch (t) {
                                i.onError("Client tool execution failed with following error: " + (null == t ? void 0 : t.message), {
                                    clientToolName: n.client_tool_call.tool_name
                                }), i.connection.sendMessage({
                                    type: "client_tool_result",
                                    tool_call_id: n.client_tool_call.tool_call_id,
                        ...
                        if (i.options.onUnhandledClientToolCall) {
                            i.options.onUnhandledClientToolCall(n.client_tool_call);
                            break;
                        }
                        i.onError(`Client tool with name ${n.client_tool_call.tool_name} is not defined on client`, {
                            clientToolName: n.client_tool_call.tool_name
                        }), i.connection.sendMessage({
                            type: "client_tool_result",
                            tool_call_id: n.client_tool_call.tool_call_id,
                            result: `Client tool with name ${n.client_tool_call.tool_name} is not defined on client`,
                            is_error: !0
                        });
                        break;
                    case "audio":
                        i.lastInterruptTimestamp <= n.audio_event.event_id && (i.addAudioBase64Chunk(n.audio_event.audio_base_64), i.updateMode("speaking"));
                        break;
                    case "ping":
                        i.connection.sendMessage({
                            type: "pong",
                            event_id: n.ping_event.event_id
                        });
                        break;
                    default:
                        i.options.onDebug(n);
                ...
                return void i.onError("Failed to parse event data", {
                    event: t
                });
            }
        ...
        }, this.onOutputWorkletMessage = ({ data: t })=>{
            "process" === t.type && this.updateMode(t.finished ? "listening" : "speaking");
            ...
            console.error(t, e), this.options.onError(t, e);
        }, this.calculateVolume = (t)=>{
            if (0 === t.length) return 0;
            let e = 0;
            for(let n = 0; n < t.length; n++)e += t[n] / 255;
            return e /= t.length, e < 0 ? 0 : e > 1 ? 1 : e;
        }, this.getId = ()=>this.connection.conversationId, this.setVolume = ({ volume: t })=>{
            this.volume = t;
